...
def test_filtering_by_main_labels():
    expected = Dictionary([
        ('HEADER', 'AH Dictionary'),
        ('PHRASE', 'mint', '/mɪnt/'),
        ('AUDIO', 'https://www.ahdictionary.com/application/resources/wavs/M0321900.wav'),
...
def test_filtering_by_definition_label():
    expected = Dictionary([
        ('HEADER', 'AH Dictionary'),
        ('PHRASE', 'sing', '/sɪŋ/'),
        ('AUDIO', 'https://www.ahdictionary.com/application/resources/wavs/S0424300.wav'),
...
def test_label_filters_not_matching():
    expected = Dictionary([
        ('HEADER', 'AH Dictionary'),
        ('PHRASE', 'mint', '/mɪnt/'),
        ('AUDIO', 'https://www.ahdictionary.com/application/resources/wavs/M0321900.wav'),
    ...
    _run_test(ahd_bend_dict, ['asdf'], expected)


def test_empty_string_filter():
    expected = Dictionary([
        ('HEADER', 'AH Dictionary'),
        ('PHRASE', 'sing', '/sɪŋ/'),
        ('AUDIO', 'https://www.ahdictionary.com/application/resources/wavs/S0424300.wav'),
...
def test_filtering_definitions_by_text_without_whitespace():
    expected = Dictionary([
        ('HEADER', 'AH Dictionary'),
        ('PHRASE', 'mint', '/mɪnt/'),
        ('AUDIO', 'https://www.ahdictionary.com/application/resources/wavs/M0321900.wav'),
...
def test_filtering_definitions_by_text_with_whitespace():
    expected = Dictionary([
        ('HEADER', 'AH Dictionary'),
        ('PHRASE', 'mint', '/mɪnt/'),
        ('AUDIO', 'https://www.ahdictionary.com/application/resources/wavs/M0321900.wav'),
...
def test_filtering_definitions_by_text_empty_slash():
    expected = Dictionary([
        ('HEADER', 'AH Dictionary'),
        ('PHRASE', 'mint', '/mɪnt/'),
        ('AUDIO', 'https://www.ahdictionary.com/application/resources/wavs/M0321900.wav'),
