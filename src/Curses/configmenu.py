    ...
    Column([
        Section(
            ...
            [
                ...
                Option('colors.success', 'Color of success notifications', _colors),
                Option('colors.syn', 'Color of synonyms', _colors),
                Option('colors.syngloss', 'Color of glosses in synonyms', _colors),
            ]
        )
    ])
]
